	...
	render() {
		return (
			<div style={Container}>
				...
				<input style={Input} placeholder="Write a new post..." maxLength={80} value={this.state.task} type='text' onKeyPress={this.handleKey} task={this.state.task} onChange={this.onChange}/>
